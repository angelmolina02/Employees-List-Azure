...
Se desea guardar la lista de empleados con sus datos personales
Implemente una solución automatizada para desplegar esta aplicación.
Implemente un proxy reverso para el contenido estático de su aplicación.
Debe hacer una presentación de su solución.
Diagrama
Explicación de la solución.

Consideraciones:
Considere el servicio necesario
Debe llevar el control del código de su solución.
Cree una aplicación con el lenguaje de su preferencia.
El framework de su preferencia.
Conocer el estado del código a nivel de OWASP
Si las librerías usadas tienen vulnerabilidades
Implemente la solución usando Infraestructure as a Code
Usar Azure Cloud o GCP Cloud
La solución debe ser orientada a los costos más bajos.
